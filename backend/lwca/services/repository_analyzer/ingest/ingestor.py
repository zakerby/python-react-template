...
from lwca.services.repository_analyzer.ingest.constants import CHROMA_SETTINGS, LOADER_MAPPING, LANG_MAPPINGS
...
class Ingestor:
    ...
    def ingest(self) -> None:
        ...
        print(
            f"Vectorstore created, user can now to use the LLM to interact with the ingested code"
        )